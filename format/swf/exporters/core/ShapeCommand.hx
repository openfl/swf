...
enum ShapeCommand {
	...
	BeginGradientFill (fillType:GradientType, colors:Array<UInt>, alphas:Array<Float>, ratios:Array<Float>, matrix:Matrix, spreadMethod:SpreadMethod, interpolationMethod:InterpolationMethod, focalPointRatio:Float);
