...
interface IShapeExporter
{
	...
	function beginGradientFill(type:GradientType, colors:Array<Int>, alphas:Array<Float>, ratios:Array<Float>, matrix:Matrix = null, spreadMethod:SpreadMethod = "pad", interpolationMethod:InterpolationMethod = "rgb", focalPointRatio:Float = 0):Void;
